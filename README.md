## gtsam (kilted) - 4.3.1-1

The packages in the `gtsam` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted gtsam` on `Thu, 24 Sep 2026 11:26:44 -0000`
...
## gtsam (lyrical) - 4.3.1-1

The packages in the `gtsam` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical --track lyrical gtsam` on `Thu, 24 Sep 2026 11:17:02 -0000`
...
## gtsam (kilted) - 4.3.0-3

The packages in the `gtsam` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r kilted gtsam` on `Wed, 19 Nov 2025 08:46:47 -0000`
...
## gtsam (kilted) - 4.3.0-2

The packages in the `gtsam` repository were released into the `kilted` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r kilted -y gtsam` on `Fri, 20 Jun 2025 22:31:45 -0000`
...
## gtsam (rolling) - 4.3.0-2

The packages in the `gtsam` repository were released into the `rolling` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r rolling gtsam` on `Fri, 20 Jun 2025 22:24:07 -0000`
